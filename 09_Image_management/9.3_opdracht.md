...
**4)** Zoek nu op DockerHub naar je net aangemaakte repository `<Docker_ID>/mijn-debian` en bevestig dat je de `:dev` tag ziet. Het kan dit dit door het indexeren wat langer duurt, controleer in dat geval je eigen repository via je account.
