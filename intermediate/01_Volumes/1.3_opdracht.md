...
> Opdracht: Gebruik nu de diverse `docker` commands zoals `docker container inspect`, `docker volume ls` en `dockere volume inspect` om te achterhalen waar op je host systeem de data feitelijk wordt weggeschreven.
---
