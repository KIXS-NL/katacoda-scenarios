...
> Opdracht: Gebruik nu de diverse `docker volume` commands zoals `docker volume ls` en `dockere volume inspect` om te achterhalen waar op je host systeem de data feitelijk wordt weggeschreven.
---
