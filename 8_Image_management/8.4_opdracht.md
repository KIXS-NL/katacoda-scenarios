**1)** Ga met de browser naar [DockerHub](https://hub.docker.com) en log daar in indien nodig. Ga nu naar je eigen repository en zoek naar de `..` om je repository op `private` te zetten.
